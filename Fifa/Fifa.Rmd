---
title: "Analysis to Help Club Managers"
...
wss_df <- data.frame(num_cluster = 30, wgss = wss)
...
- Model what a player's wage should be
- Create code to create a "league" feature to be able to analyse each league
